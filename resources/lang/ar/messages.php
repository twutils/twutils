...
return [
    ...
    'confirmRemoveExport' => 'هل أنت متأكد من رغبتك في حذف هذا التصدير؟',
    ...
    'with_media_task_description' => 'قم بتصدير مرفقات التغريدات أيضاً ”Html مع الوسائط“ بعد اكتمال المهمة',
    'you_can_do_this_later'       => 'يمكنك القيام بذلك لاحقاً',
    ...
    'destroy_tweets_options' => [
        'dates_range'       => 'النطاق التاريخي',
        'dates_range_desc'  => 'باستخدام هذا الخيار يمكنك تحديد النطاق التاريخي للتغريدات المُراد حذفها.',
        'dates_range_note'  => 'ترك هذا الخيار فارغاً سيحذف جميع التغريدات من البداية حتي النهاية.',

        'tweets_source'         => 'مصدر التغريدات',
    ],

    'destroy_tweets_confirmation'   => 'بالموافقة، سوف تقوم بحذف التغريدات من حسابك في تويتر. هذا الإجراء غير قابل للتراجع.',
    'destroy_likes_confirmation'    => 'بالموافقة، سوف تقوم بحذف المفضّلة من حسابك في تويتر بحسب النطاق المحدد. هذا الإجراء غير قابل للتراجع.',

    'destroy_tweets_confirmation_button' => 'حذف تغريداتي',
    'destroy_likes_confirmation_button'  => 'حذف مفضّلتي',
